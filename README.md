...
<ul>
  ...
  <li>Note #3: You will need to create a Key Pair through web console. Edit <code>servers.yml</code> file and update value of the attribute KeyName in the resource AWS::AutoScaling::LaunchConfiguration.</li>
</ul>
